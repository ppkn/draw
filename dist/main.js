...
var $author$project$Main$Pencil = 0;
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{A: $author$project$Main$initialCells, t: 0, E: 0},
...
var $author$project$Main$Filled = 1;
		...
		switch (msg.$) {
			case 0:
				...
				if (!_v1) {
					...
					var newState = (!model.E) ? 1 : 0;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								A: A3($elm$core$Dict$insert, index, newState, model.A)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
...
var $author$project$Main$MouseDownCanvas = {$: 1};
...
var $author$project$Main$MouseOverCell = function (a) {
	return {$: 0, a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('filled', state === 1)
					])),
				$elm$html$Html$Events$onMouseOver(
				$author$project$Main$MouseOverCell(index))
			]),
		_List_Nil);
};
var $author$project$Main$viewCells = function (model) {
	return A2(
		$elm$core$List$map,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onMouseDown($author$project$Main$MouseDownCanvas)
			]),
		$author$project$Main$viewCells(model));
};
var $author$project$Main$Eraser = 1;
var $author$project$Main$SelectTool = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$viewToolbar = function (_v0) {
	var tool = _v0.E;
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$name('tool'),
						$elm$html$Html$Attributes$id('pencil'),
						$elm$html$Html$Attributes$value('pencil'),
						$elm$html$Html$Attributes$checked(!tool),
						$elm$html$Html$Events$onClick(
						$author$project$Main$SelectTool(0))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for('pencil')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Pencil')
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('radio'),
						$elm$html$Html$Attributes$name('tool'),
						$elm$html$Html$Attributes$id('eraser'),
						$elm$html$Html$Attributes$value('eraser'),
						$elm$html$Html$Attributes$checked(tool === 1),
						$elm$html$Html$Events$onClick(
						$author$project$Main$SelectTool(1))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for('eraser')
					]),
				_List_fromArray(
					[
